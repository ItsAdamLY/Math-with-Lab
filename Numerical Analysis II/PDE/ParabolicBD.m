function W = ParabolicBD(fun,bv,h,k,alp2,T,D)

   %FFDParabolic to solve Parabolic PDE by Backward Finite Diff Scheme
   ...
   lam=alp2*k/h^2; dd=(1+2*lam)*ones(m-2,1); od=-lam*ones(m-3,1);
